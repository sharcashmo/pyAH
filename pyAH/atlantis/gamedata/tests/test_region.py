...
class TestRegion(unittest.TestCase):
    ...
    def test_json_methods(self):
        ...
        region.append_report_description('')
        region.append_report_description('There is a Gate here (Gate 654).')
        region.set_gate(654, True)
        region.append_report_description('')
        region.append_report_description('+ Building [1] : Mine.')
        region.pop_report_description()
        s = Structure(1, 'Building', 'Mine')
        region.append_structure(s)
